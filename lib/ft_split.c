...
/*   Updated: 2026/05/29 18:44:59 by durisosa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_split_substr(const char *s, unsigned int start, unsigned int len)
{
	size_t	i;
	char	*substr;
...
char	**ft_execute_split(char **split, const char *s, char c)
{
	int	k;
	int	i;
	int	j;
